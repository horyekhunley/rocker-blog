...
const {validationRules, validate} = require("../validation/videoValidator");
const { addOne, removeOne, updateOne, getAll, getOne, getTopVideos } = require("../controllers/videosCtrl");
